"""API views para la gestión de usuarios."""
...
def validate_password(request):
    ...
    try:
        ...
        if user is not None and user == request.user:
            ...
            logger.info("Validación de contraseña exitosa para usuario: %s", request.user.username)
            ...
            logger.warning("Intento de validación de contraseña fallido para usuario: %s", request.user.username)
        ...
        logger.error("Error en validación de contraseña: %s", str(e))
        return Response({
